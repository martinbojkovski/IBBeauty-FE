...
const Posts = ({ token }) => {
    ...
    const fetchPosts = async () => {
        try {
            const response = await fetch(`https://64.227.123.235:8443/post/paginated?page=${page}&size=10`);
    ...
    const handleDeletePost = async () => {
        try {
            await fetch(`https://64.227.123.235:8443/post/delete/${postToDelete.id}`, {
                method: "DELETE",
